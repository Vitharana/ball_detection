...
mov_avg_filter = Moving_Average(3)


from motion_checker import Motion_Checker
ball_motion_checker = Motion_Checker(points_to_check=3)
...
def run_data_analyser(cv2):
    ...
    if cv2.d_key == '1':
        ...
        print("Initial Coordinate Saved")
